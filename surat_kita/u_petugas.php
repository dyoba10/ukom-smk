    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link disabled" href="logout.php">Disabled</a>
          </li>
        </ul>
    ...
    <main role="main" class="container">
      ...
      <div class="card-body">
       <a href="petugas.php" class="btn btn-primary">Daftar Petugas</a>
          ...
          <h2 class="sub-header">Edit data Petugas</h2>
      <form action="p_u_petugas.php" method="POST" class="form-horizontal" role="form">
        
        <div class="form-group">
          <label class="col-sm-2 control-label">ID Petugas</label>
          <div class="col-sm-8">
            <input type="username" class="form-control" name="id_petugas" placeholder="ID Petugas" value="<?php echo $r['id_petugas']; ?>" required readonly>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="username" class="form-control" name="nama_depan" placeholder="Nama Depan" value="<?php echo $r['nama_depan']; ?>" required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="username" class="form-control" name="nama_belakang" placeholder="Nama Belakang" value="<?php echo $r['nama_belakang']; ?>" required>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="password" class="form-control" name="password" placeholder="Password" value="<?php echo $r['pasword']; ?>" required>
          </div>
        </div>
