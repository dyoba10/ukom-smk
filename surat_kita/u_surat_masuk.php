    ...
    <main role="main" class="container">
      ...
      <div class="card-body">
       <a href="surat_masuk.php" class="btn btn-primary">Daftar Surat Masuk</a>
          ...
          <h2 class="sub-header">Edit Surat Masuk</h2>
      <form action="p_u_surat_masuk.php" method="POST" class="form-horizontal" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" name="tgl_terima" placeholder="Tanggal Terima" value="<?php echo $r['tgl_terima'] ?>" required>
          </div>
        </div>
