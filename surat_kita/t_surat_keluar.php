    ...
    <main role="main" class="container">
      ...
      <div class="card-body">
       <a href="surat_keluar.php" class="btn btn-primary">Daftar Surat Keluar</a>
          ...
          <h2 class="sub-header">Tambah Surat Keluar</h2>
      <form action="p_surat_keluar.php" method="POST" class="form-horizontal" role="form">
        
        <div class="form-group">
          <label class="col-sm-2 control-label">No Agenda</label>
          <div class="col-sm-8">
            <input type="username" class="form-control" name="no_agenda" placeholder="No Agenda" required>
          </div>
        </div>
