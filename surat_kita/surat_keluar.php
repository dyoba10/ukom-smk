    ...
    <main role="main" class="container">
     ...
     <div class="card col-md-12 card border-dark mb-3">
      ...
      <h5 class="card-title">Daftar Surat Keluar</h5>
       <a href="t_surat_keluar.php" class="btn btn-primary">Tambah Surat Keluar</a>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <td>
                  <a href="u_surat_keluar.php?id=<?php echo $row['no_agenda']; ?>" class="btn btn-warning">Update</a> 
                </td>
                <td><a href="h_surat_keluar.php?id=<?php echo $row['no_agenda']; ?>" class="btn btn-danger">Delete</a></td>
                </tr>
              </tbody>
              <?php 
                  $no++;
